...
cities_acs_places_ref <- read_csv("https://raw.githubusercontent.com/ada-parc/ADA-PARC-Website-Design/master/dictionaries/dict_places.txt") %>% 
  filter(!is.na(POP))
...
tracts_places_counties <- reactive({ 
  ...
  read_csv("https://raw.githubusercontent.com/ada-parc/ADA-PARC-Website-Design/master/dictionaries/dict_location_crosswalk.txt") %>%

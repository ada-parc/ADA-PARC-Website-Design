---
title: "ADA-PARC TESTING (currently:2022)"
output:
...
ui <- fluidPage(
  ...
  div(class = "main-content",
      ...
      # Did You Know Section with HTML image for Poverty
      div(class = "section-title", "Did You Know?"),
      div(class = "section-content", "According to 2022 ACS data, between the ages of 18 to 64, 1 in 4 individuals with a disability live below the poverty line."),
      img(src = "below_poverty.png", alt = "Below Poverty Line Statistics", style = "width: 75%;"),
      ...
      # Questions Section with HTML email button
      ...
      # HTML image for participant logos
      img(src = "participant_logos.png", alt = "The ten participating ADA-Regional Centers", style = "width: 75%;"),
  ...
  tags$head(
    tags$style(HTML("
      ...
      .table_national th {
        position: sticky;
        top: 0;
        background-color: #F8D7DA; /* Pastel red background color for the header */
            ...
            tags$section(role = "region", 
                         ...
                         tags$aside(class = "sidebar",
                                    ...
                                    selectInput(inputId = "national_category_selector", 
                                                ...
                                                choices = c("Demographics", "Community Participation", 
                                                            "Community Living", "Work/Economic"),
...
server <- function(input, output, session) {
  ...
  pal_city <- reactive({
    ...
    if (length(city_tract_pwd_total) < 4) {
      colorNumeric(palette = map_palette, domain = city_tract_pwd_total)
    } else {
      colorQuantile(palette = map_palette, domain = city_tract_pwd_total, n = 4)
    }
  })
  ...
  output$snapshotmap <- renderLeaflet({
    ...
    data <- left_join(city_tract_sf(), city_tract() %>% select(GEOID, pwd_total), by = c("tract_GEOID" = "GEOID")) %>%
    ...
    leaflet(data) %>%
      ...
      addPolygons(
        ...
        fillColor = ~pal_city()(pwd_total), fillOpacity = 0.5, layerId = ~tract_GEOID
      ) %>%
      addLegend(
        position = "topright", pal = pal_city(), values = ~pwd_total,
        labFormat = function(type, cuts, p) {
          paste0(as.numeric(cuts)[-length(cuts)], " – ", as.numeric(cuts)[-1])
        },
  ...
  output$city_summary <- renderUI({
    ...
    city_summary_text <- paste0(
      ...
      "Based on ACS 2022 5-Year Estimates, <b>", city_place()$pwd_total, "</b> of the city's <b>", 
    ...
    disability_types <- city_place() %>% transmute(
      ...
      SelfCare = pwd_selfcare,
      IndependentLiving = pwd_indliving
    ) %>% 
      pivot_longer(everything(), names_to = "Type of Disability", values_to = "Total") %>%
      mutate("Bullets" = paste0('<li>', `Type of Disability`, " &mdash; ", Total, '</li>')) %>%
      pull(Bullets) %>% 
      str_c(collapse = "")
    
    # Create summary items for Key Indicators
    key_indicators <- city_place() %>% transmute(
      LivingInPoverty = create_number_percent_string(pwd_below_poverty, pwd_below_poverty_pct),
    ...
    city_summary_tables <- paste0(
      '<div class = "row">',
      '<div class = "col-md-12"><b>Demographics</b><ul>', demographics, '</ul></div>',
      '<div class = "col-md-12"><b>Disability Types</b><ul>', disability_types, '</ul></div>',
      '<div class = "col-md-12"><b>Key Indicators</b><ul>', key_indicators, '</ul></div>',
      '</div>'
    )
...
ui <- fluidPage(
  # Application title
  titlePanel("Work Economic Tableau Dashboard"),
  
  # Static embed for Work Economic dashboard
  fluidRow(
    column(
      width = 12,
      HTML("
        <div class='tableauPlaceholder' id='viz1732576247026' style='position: relative'>
          <noscript>
            <a href='#'>
              <img alt=' ' src='https://public.tableau.com/static/images/Wo/WorkEconomic2022ADAPARCACS/WorkEconomicOverallDash/1_rss.png' style='border: none' />
            </a>
          </noscript>
          <object class='tableauViz' style='display:none;'>
            ...
            <param name='name' value='WorkEconomic2022ADAPARCACS/WorkEconomicOverallDash' />
            <param name='tabs' value='yes' />
            <param name='toolbar' value='yes' />
            <param name='static_image' value='https://public.tableau.com/static/images/Wo/WorkEconomic2022ADAPARCACS/WorkEconomicOverallDash/1.png' />
        ...
        <script type='text/javascript'>
          var divElement = document.getElementById('viz1732576247026');
...
# Define server logic (no server logic needed for static display)
server <- function(input, output, session) {
...
# Scorecard Community Participation
```{r}
library(shiny)
...
ui <- fluidPage(
  # Application title
  titlePanel("Community Participation Tableau Dashboard"),
  
  # Static embed for Community Participation dashboard
  fluidRow(
    column(
      width = 12,
      HTML("
        <div class='tableauPlaceholder' id='viz1732576408249' style='position: relative'>
          <noscript>
            <a href='#'>
              <img alt='Community Participation Dashboard' src='https://public.tableau.com/static/images/Co/CommunityParticipation2022ADAPARCACS/CommunityParticipationOverallDash/1_rss.png' style='border: none' />
            </a>
          </noscript>
          <object class='tableauViz' style='display:none;'>
            <param name='host_url' value='https%3A%2F%2Fpublic.tableau.com%2F' />
            <param name='embed_code_version' value='3' />
            <param name='site_root' value='' />
            <param name='name' value='CommunityParticipation2022ADAPARCACS/CommunityParticipationOverallDash' />
            <param name='tabs' value='yes' />
            <param name='toolbar' value='yes' />
            <param name='static_image' value='https://public.tableau.com/static/images/Co/CommunityParticipation2022ADAPARCACS/CommunityParticipationOverallDash/1.png' />
            <param name='animate_transition' value='yes' />
            <param name='display_static_image' value='yes' />
            <param name='display_spinner' value='yes' />
            <param name='display_overlay' value='yes' />
        ...
        <script type='text/javascript'>
          var divElement = document.getElementById('viz1732576408249');
          var vizElement = divElement.getElementsByTagName('object')[0];
          if ( divElement.offsetWidth > 800 ) {
            vizElement.style.minWidth = '1000px';
            vizElement.style.maxWidth = '100%';
...
ui <- fluidPage(
  # Application title
  titlePanel("Community Living Tableau Dashboard"),
  
  # Static embed for Community Living dashboard
  fluidRow(
    column(
      width = 12,
      HTML("
        <div class='tableauPlaceholder' id='viz1732576520400' style='position: relative'>
          <noscript>
            <a href='#'>
              <img alt='Community Living Dashboard' src='https://public.tableau.com/static/images/Co/CommunityLiving2022ADA-PARCACS/CommunityLivingGeneralDash/1_rss.png' style='border: none' />
            </a>
          </noscript>
          <object class='tableauViz' style='display:none;'>
            <param name='host_url' value='https%3A%2F%2Fpublic.tableau.com%2F' />
            <param name='embed_code_version' value='3' />
            <param name='site_root' value='' />
            <param name='name' value='CommunityLiving2022ADA-PARCACS/CommunityLivingGeneralDash' />
            <param name='tabs' value='yes' />
            <param name='toolbar' value='yes' />
            <param name='static_image' value='https://public.tableau.com/static/images/Co/CommunityLiving2022ADA-PARCACS/CommunityLivingGeneralDash/1.png' />
            <param name='animate_transition' value='yes' />
            <param name='display_static_image' value='yes' />
            <param name='display_spinner' value='yes' />
            <param name='display_overlay' value='yes' />
        ...
        <script type='text/javascript'>
          var divElement = document.getElementById('viz1732576520400');
          var vizElement = divElement.getElementsByTagName('object')[0];
          if ( divElement.offsetWidth > 800 ) {
            vizElement.style.minWidth = '1000px';
            vizElement.style.maxWidth = '100%';
...
ui <- fluidPage(
  # Application title
  titlePanel("Dynamic Scorecard Dashboard"),
    ...
    if (input$scorecard_choice == "participation") {
      ...
      HTML("
        <div class='tableauPlaceholder' id='viz1732576247026' style='position: relative'>
          <noscript>
            <a href='#'>
              <img alt='Work Economic Dashboard' src='https://public.tableau.com/static/images/Wo/WorkEconomic2022ADAPARCACS/WorkEconomicOverallDash/1_rss.png' style='border: none' />
            </a>
          </noscript>
          <object class='tableauViz' style='display:none;'>
            <param name='host_url' value='https%3A%2F%2Fpublic.tableau.com%2F' />
...
access_map_palette_choices <- list(
  ...
  "Red-Blue Diverging" = "RdBu"  # New option
)
...
tags$div(
  ...
  tags$a(
    ...
    "Download information on the ADA-PARC scorecards"
  )
)

...
Use the **Scorecard** tabs to view our state by state report cards for
each category.
...
Application authors: <br> Ethan Jantz, Sean Connelly, Jane Huber, Colin
Heeneman, and Randy D. Colón <br> [UIC Voorhees
...
ADA-PARC is a collaborative research initiative comprising ten regional
centers focused on the Americans with Disabilities Act (ADA).
:::

::: main
### What is the ADA?

The Americans with Disabilities Act (ADA), established in 1990, is a
landmark civil rights law that prohibits discrimination against
...
-   Organizations across public and private sectors have diligently
    worked to collect, interpret, and analyze data to improve the
    quality of life for individuals with disabilities in the U.S.
-   ADA-PARC emphasizes key components of Census and HUD data to shed
    light on the lived experiences and outcomes for people with
    disabilities.
:::
...
*Illinois has the highest percentage of its disabled population aged
18-64 living in nursing homes.*
:::

::: main
### Grant Information

ADA-PARC is funded by the National Institute on Disability, Independent
Living, and Rehabilitation Research (NIDILRR) under grant numbers
90DP0026 and 90DPAD0001.

NIDILRR is a center within the Administration for Community Living (ACL)
at the Department of Health and Human Services (HHS). The content of
this website does not necessarily reflect the policy of NIDILRR, ACL, or
HHS and should not be regarded as endorsed by the Federal Government.
:::
...
There are two basic ways we can think about the 'state of affairs' for
the disabled population in any given state x for metric y:

1.  How does disabled population in state x fare on metric y compared to
    disabled population in other states? (relative)
2.  How does disabled population ins tate x fare on metric y compared to
    non-disabled population in own state? (disparity/equity)

Relative scores indicate how favorable conditions are for a given
state's disabled population compared to the disabled population of other
states, the higher the value, the more favorable conditions for that
state's disabled population relative to the median state's disabled
population.

Equity scores measures how favorable conditions are for a given state's
disabled population relative to the non-disabled population of the same
state, the higher the value, the more favorable conditions are for that
state's disabled population relative to the non-disabled population of
that state.
...
shinyApp(
        ...
        div(class = "main-content",
            tags$head(
              tags$style(HTML("
                ...
                #tableauContainer {
                  width: 100%;
                  height: 800px; /* Set the height to 800px or any value you prefer */
                  padding: 0;
                  margin: 0;
                }
  ...
  server = function(input, output, session) {
    ...
    # Observe the selected dimension and category to render the corresponding Tableau dashboard
    output$scorecard_output <- renderUI({
      req(input$category)
      category <- input$category
        ...
        tags$div(
          ...
          tags$noscript(
            tags$a(
              href = '#',
              tags$img(
                alt = 'Community Living - Relative Scores - Select State',
                src = 'https://public.tableau.com/static/images/Re/Relative_Living_Dash/CommunityLiving-RelativeScores-SelectState/1_rss.png',
                style = 'border: none'
              )
            )
          ),
          tags$object(
            ...
            tags$param(name = 'name', value = 'Relative_Living_Dash/CommunityLiving-RelativeScores-SelectState'),
            tags$param(name = 'tabs', value = 'yes'),
            tags$param(name = 'toolbar', value = 'yes'),
            tags$param(name = 'static_image', value = 'https://public.tableau.com/static/images/Re/Relative_Living_Dash/CommunityLiving-RelativeScores-SelectState/1.png'),
            ...
            tags$param(name = 'filter', value = 'publish=yes')
          ),
          tags$script(
            HTML("
              var divElement = document.getElementById('viz1723223564502');
        ...
        tags$div(
          ...
          tags$noscript(
            tags$a(
              href = '#',
              tags$img(
                alt = 'Community Participation - Relative Scores By State - Bar Chart',
                src = 'https://public.tableau.com/static/images/Re/Relative_Participation_Dash/CommunityParticipation-RelativeScoresByState-BarChart/1_rss.png',
                style = 'border: none'
              )
            )
          ),
          tags$object(
            ...
            tags$param(name = 'embed_code_version', value = '3'),
            tags$param(name = 'site_root', value = ''),
            tags$param(name = 'name', value = 'Relative_Participation_Dash/CommunityParticipation-RelativeScoresByState-BarChart'),
            tags$param(name = 'tabs', value = 'yes'),
            tags$param(name = 'toolbar', value = 'yes'),
            tags$param(name = 'static_image', value = 'https://public.tableau.com/static/images/Re/Relative_Participation_Dash/CommunityParticipation-RelativeScoresByState-BarChart/1.png'),
            tags$param(name = 'animate_transition', value = 'yes'),
            tags$param(name = 'display_static_image', value = 'yes'),
            tags$param(name = 'display_spinner', value = 'yes'),
            tags$param(name = 'display_overlay', value = 'yes'),
          ...
          tags$script(
            HTML("
              var divElement = document.getElementById('viz1723236124105');
              var vizElement = divElement.getElementsByTagName('object')[0];
              vizElement.style.width='100%';
              vizElement.style.height=(divElement.offsetWidth*0.75)+'px';
              var scriptElement = document.createElement('script');
        ...
        tags$div(
          ...
          tags$noscript(
            tags$a(
              href = '#',
              tags$img(
                alt = 'Relative Work Economic - Scores By State - Map',
                src = 'https://public.tableau.com/static/images/Re/Relative_Work_Dash/RelativeWorkEconomic-ScoresByState-Map/1_rss.png',
                style = 'border: none'
              )
            )
          ),
          tags$object(
            ...
            tags$param(name = 'embed_code_version', value = '3'),
            tags$param(name = 'site_root', value = ''),
            tags$param(name = 'name', value = 'Relative_Work_Dash/RelativeWorkEconomic-ScoresByState-Map'),
            tags$param(name = 'tabs', value = 'yes'),
            tags$param(name = 'toolbar', value = 'yes'),
            tags$param(name = 'static_image', value = 'https://public.tableau.com/static/images/Re/Relative_Work_Dash/RelativeWorkEconomic-ScoresByState-Map/1.png'),
            tags$param(name = 'animate_transition', value = 'yes'),
            tags$param(name = 'display_static_image', value = 'yes'),
            tags$param(name = 'display_spinner', value = 'yes'),
            tags$param(name = 'display_overlay', value = 'yes'),
          ...
          tags$script(
            HTML("
              var divElement = document.getElementById('viz1723236150123');
              var vizElement = divElement.getElementsByTagName('object')[0];
              vizElement.style.width='100%';
              vizElement.style.height=(divElement.offsetWidth*0.75)+'px';
              var scriptElement = document.createElement('script');
        ...
        tags$div(
          ...
          tags$noscript(
            tags$a(
              href = '#',
              tags$img(
                alt = 'Community Living Equity Scores - Select Measure',
                src = 'https://public.tableau.com/static/images/Di/Disparity_Living_Dash/CommunityLivingEquityScores-SelectMeasure/1_rss.png',
                style = 'border: none'
              )
            )
          ),
          tags$object(
            ...
            tags$param(name = 'embed_code_version', value = '3'),
            tags$param(name = 'site_root', value = ''),
            tags$param(name = 'name', value = 'Disparity_Living_Dash/CommunityLivingEquityScores-SelectMeasure'),
            tags$param(name = 'tabs', value = 'yes'),
            tags$param(name = 'toolbar', value = 'yes'),
            tags$param(name = 'static_image', value = 'https://public.tableau.com/static/images/Di/Disparity_Living_Dash/CommunityLivingEquityScores-SelectMeasure/1.png'),
            tags$param(name = 'animate_transition', value = 'yes'),
            tags$param(name = 'display_static_image', value = 'yes'),
            tags$param(name = 'display_spinner', value = 'yes'),
            tags$param(name = 'display_overlay', value = 'yes'),
          ...
          tags$script(
            HTML("
              var divElement = document.getElementById('viz1723236194478');
              var vizElement = divElement.getElementsByTagName('object')[0];
              vizElement.style.width='100%';
              vizElement.style.height=(divElement.offsetWidth*0.75)+'px';
              var scriptElement = document.createElement('script');
        ...
        tags$div(
          ...
          tags$noscript(
            tags$a(
              href = '#',
              tags$img(
                alt = 'Community Participation Equity Scores - Select Measure',
                src = 'https://public.tableau.com/static/images/Di/Disparity_Participation_Dash/CommunityParticipationEquityScores-SelectMeasure/1_rss.png',
                style = 'border: none'
              )
            )
          ),
          tags$object(
            ...
            tags$param(name = 'embed_code_version', value = '3'),
            tags$param(name = 'site_root', value = ''),
            tags$param(name = 'name', value = 'Disparity_Participation_Dash/CommunityParticipationEquityScores-SelectMeasure'),
            tags$param(name = 'tabs', value = 'yes'),
            tags$param(name = 'toolbar', value = 'yes'),
            tags$param(name = 'static_image', value = 'https://public.tableau.com/static/images/Di/Disparity_Participation_Dash/CommunityParticipationEquityScores-SelectMeasure/1.png'),
            tags$param(name = 'animate_transition', value = 'yes'),
            tags$param(name = 'display_static_image', value = 'yes'),
            tags$param(name = 'display_spinner', value = 'yes'),
            tags$param(name = 'display_overlay', value = 'yes'),
          ...
          tags$script(
            HTML("
              var divElement = document.getElementById('viz1723236229625');
              var vizElement = divElement.getElementsByTagName('object')[0];
              vizElement.style.width='100%';
              vizElement.style.height=(divElement.offsetWidth*0.75)+'px';
              var scriptElement = document.createElement('script');
        ...
        tags$div(
          ...
          tags$noscript(
            tags$a(
              href = '#',
              tags$img(
                alt = 'Work Economic Equity Scores - Select State',
                src = 'https://public.tableau.com/static/images/Di/Disparity_Work_Dash/WorkEconomicEquityScores-SelectState/1_rss.png',
                style = 'border: none'
              )
            )
          ),
          tags$object(
            ...
            tags$param(name = 'embed_code_version', value = '3'),
            tags$param(name = 'site_root', value = ''),
            tags$param(name = 'name', value = 'Disparity_Work_Dash/WorkEconomicEquityScores-SelectState'),
            tags$param(name = 'tabs', value = 'yes'),
            tags$param(name = 'toolbar', value = 'yes'),
            tags$param(name = 'static_image', value = 'https://public.tableau.com/static/images/Di/Disparity_Work_Dash/WorkEconomicEquityScores-SelectState/1.png'),
            tags$param(name = 'animate_transition', value = 'yes'),
            tags$param(name = 'display_static_image', value = 'yes'),
            tags$param(name = 'display_spinner', value = 'yes'),
            tags$param(name = 'display_overlay', value = 'yes'),
          ...
          tags$script(
            HTML("
              var divElement = document.getElementById('viz1723236258470');
              var vizElement = divElement.getElementsByTagName('object')[0];
              vizElement.style.width='100%';
              vizElement.style.height=(divElement.offsetWidth*0.75)+'px';
              var scriptElement = document.createElement('script');
...
Below is the scorecard report, with the option for download!

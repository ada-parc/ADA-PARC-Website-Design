...
ui <- fluidPage(
  ...
  div(class = "main-content",
      ...
      div(class = "demographic-header", "Demographic Explorer"),  # Header added here
      
      # Updated Tableau embed code
      div(class = 'tableauPlaceholder', id = 'viz1724171392978', style = 'position: relative;',
          tags$noscript(
            a(href = '#',
      ...
      tags$script(type = 'text/javascript',
                  HTML("var divElement = document.getElementById('viz1724171392978');

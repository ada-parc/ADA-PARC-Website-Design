...
<div style="text-align: center; margin-top: 20px; margin-bottom: 20px;">
  <img src="./www/002_Percent of People with Disabilities.png" alt="Percent of People with Disabilities" width="70%">
</div>
...
# Community Reports
```{r community_reports_documentation}

# creating a page for the state report cards per website re-design vision

```

Embed report card information here. 

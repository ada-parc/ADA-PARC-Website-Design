...
observeEvent(input$national_category_selector, {
  ...
  updateSelectInput(session, "national_variable_selector", choices = choices, selected = national_variable_choices())
  # message(national_category_selected())
  # message(national_variable_selected())
  
})

national_variable_selected <- reactive({ # Output looks like "is_demographics"
  req(national_variable_choices())
...
output$national_map <- renderUI({
  ...
  # comp_test <- isCompVar(national_category_selected(), national_variable_selected())
  # if(comp_test) {
    # print("ggmap")
    withSpinner(plotOutput("national_ggmap"))
  # } else if(!comp_test) {
  #   # print("tmap")
  #   withSpinner(tmapOutput("national_tmap"))
  # }

...
render_map <- function(data, selected, palette, title) {
  map <- data %>%
...
output$demo1map <- renderLeaflet({
  render_map(demo_gen_map_data, demo_gen_selected(), pal_demo1(), input$demo_gen_type)
})
...
output$demo2map <- renderLeaflet({
  ...
  # Map
  render_map(demo_age_map_data, demo_age_selected(), pal_demo2(), input$demo_age_type)
...
output$demo3map <- renderLeaflet({
  ...
  # Map
  render_map(demo_race_map_data, demo_race_selected(), pal_demo3(), input$demo_race_type)
...
output$demo4map <- renderLeaflet({
  ...
  # Map
  render_map(demo_gender_map_data, demo_gender_selected(), pal_demo4(), input$demo_gender_type)
...
output$demo5map <- renderLeaflet({
  ...
  # Map
  render_map(demo_distype_map_data, demo_distype_selected(), pal_demo5(), input$demo_distype_type)
...
output$cl1map <- renderLeaflet({
  ...
  render_map(cl_live_map_data, cl_live_selected(), pal_cl1(), input$cl_live_type)
...
output$cl2map <- renderLeaflet({
  ...
  render_map(cl_nursing_map_data, cl_nursing_selected(), pal_cl2(), input$cl_nursing_type)
...
output$cl3map <- renderLeaflet({
  ...
  render_map(cl_ps_map_data, cl_ps_selected(), pal_cl3(), input$cl_ps_type)
...
output$cp1map <- renderLeaflet({
  ...
  # Map
  render_map(cp_insurance_map_data, cp_insurance_selected(), pal_cp1(), input$cp_insurance_type)
...
output$cp2map <- renderLeaflet({
  ...
  render_map(cp_housing_map_data, cp_housing_selected(), pal_cp2(), input$cp_housing_type)
...
output$cp3map <- renderLeaflet({
  ...
  render_map(cp_transit_map_data, cp_transit_selected(), pal_cp3(), input$cp_transit_type)
...
output$cp4map <- renderLeaflet({
  ...
  # Map
  render_map(cp_crime_map_data, cp_crime_selected(), pal_cp4(), input$cp_crime_type)
...
output$cp5map <- renderLeaflet({
  ...
  render_map(cp_education_map_data, cp_education_selected(), pal_cp5(), input$cp_education_type)
...
output$cp6map <- renderLeaflet({
  ...
  render_map(cp_voting_map_data, cp_voting_selected(), pal_cp6(), input$cp_voting_type)
...
output$we1map <- renderLeaflet({
  ...
  render_map(we_employ_map_data, we_employ_selected(), pal_we1(), input$we_employ_type)
...
output$we2map <- renderLeaflet({
  ...
  render_map(we_status_map_data, we_status_selected(), pal_we2(), input$we_status_type)
...
output$we3map <- renderLeaflet({
  ...
  render_map(we_afford_map_data, we_afford_selected(), pal_we3(), input$we_afford_type)

...
# national_category_selector is a subset of variable names from
# a selected category. Until a category is selected choices = NULL
selectInput(inputId = "national_variable_selector",
            label = "Select a variable",
            choices = NULL)

# This updates the selector choices using an observer
observeEvent(input$national_category_selector,
             {
               updateSelectizeInput(session,
                                    input = "national_variable_selector",
                                    choices = national_data() %>%

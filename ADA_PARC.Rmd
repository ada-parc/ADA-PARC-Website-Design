...
output$demo1map <- renderLeaflet({
  ...
  demo1map <- demo_gen_map_data %>%
    ...
    addControl(title, position = "topleft", className="map-title") # final piece for adding the title
...
### Input descriptions
# Metro-Area selectInput dropdown
# Variable for viz dropdown (Age, Race, Type of Disability, Gender)
# 

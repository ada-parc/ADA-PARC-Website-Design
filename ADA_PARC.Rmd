    ...
    fluidRow(
      column(
        ...
        div(class = "sidebar",
            ...
            uiOutput("category_selector"),
            br(),
            p(style = "font-size: 85%;",  # Adjusts the font size to be slightly smaller
              "Scorecard dashboards are based on data from 2022 Census Data via the ACS. For more information on their logical structure and calculation methods, see the ‘Scorecards - Report’ tab.")
        )
      ),
      column(
        width = 9,

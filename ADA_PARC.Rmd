...
ui <- fluidPage(
  ...
  div(class = "main-content",
      ...
      tags$ul(
        class = "list-content",
        tags$li("Use the National Data tab to examine the status of people with disabilities at the national and state level."),
        tags$li("Use the City Data tab to investigate people with disabilities statistics at the municipal level."),
        tags$li("Use the Scorecard tabs to view our state by state report cards for each category."),
        tags$li("Use the About tab to learn more about the ADA-PARC project."),
        tags$li("Use the Settings tab to set color palettes for the visualizations in this dashboard.")
      ),
      
      # Embed Tableau dashboard here
      div(class = 'tableauPlaceholder', id = 'viz1723579194780', style = 'position: relative;',
          tags$noscript(
            a(href = '#',
              img(src = 'https://public.tableau.com/static/images/De/Demographic_Dash/DisabilitybyRaceTotal-SelectState/1_rss.png', style = 'border: none'))
          ),
          tags$object(class = 'tableauViz', style = 'display:none;',
                      ...
                      tags$param(name = 'name', value = 'Demographic_Dash/DisabilitybyRaceTotal-SelectState'),
                      tags$param(name = 'tabs', value = 'yes'),
                      tags$param(name = 'toolbar', value = 'yes'),
                      tags$param(name = 'static_image', value = 'https://public.tableau.com/static/images/De/Demographic_Dash/DisabilitybyRaceTotal-SelectState/1.png'),
      ...
      tags$script(type = 'text/javascript',
                  HTML("var divElement = document.getElementById('viz1723579194780');

...
national_data <- reactive({!!sym(input$category)})

national_variable <- reactive({ "pwd_total" }) # TODO: Reactive to new inputs in sidebar

renderPlot({
  render_tile_map(demographics, "pwd_total")
})

...
```{r, national_map, fig.alt = "Map of the selected variables in the sidebar"}

renderPlot({
  
  req(input$national_variable_selector)
  
  render_tile_map(national_data(), input$national_variable_selector, input$access_map_palette)
...
renderUI({
  ...
  # Summary table
  national_topic_table <- knitr::kable(
    x = national_data
  )

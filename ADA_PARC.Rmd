...
selectInput(inputId = "category", 
            ...
            choices = c("Demographics" = "national_demographic", 
...
selectInput(inputId = "variable",
            ...
            choices = NULL) # TODO: Build out reactivity to category input
...
source(here("national_import.R"), local = T)
```
...
demo_gen_data <- reactive({input$category})

demo_gen_selected <- reactive({ "pwd_total" }) # TODO: Reactive to new inputs in sidebar

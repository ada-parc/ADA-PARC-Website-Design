  ...
  fluidRow(
    column(12,
      ...
      HTML("<p style='margin-top: 20px; font-size: 16px;'>
        <strong>Scorecards are based on 2022 ACS Census, currently being updated for 2023 data.</strong> Quartiles are displayed to show discrepancies in outcomes for people with disabilities across states. 

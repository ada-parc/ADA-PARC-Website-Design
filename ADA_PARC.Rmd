...
# Not 100% sure on where to put this, so it goes here for now
# The tag template for titling the maps
...
selectInput('metro_var', label = "Select a demographic variable", choices = demographic_var, selected = demographic_var[[1]])
...
### Alternative idea, we could have the metro selected in the sidebar and have the chart show the full datasheet for the selected metro
### Transposing the data with Age, Race, Disability, and Gender categories are the rows with corresponding values
```
...
access_ggplot_themes <- list(
  ...
  "Ipsum" = list(theme_ipsum(), scale_fill_ipsum(), scale_color_ipsum()),

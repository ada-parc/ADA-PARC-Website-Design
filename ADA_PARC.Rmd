  ...
  fluidRow(
    column(12,
      ...
      HTML("<p style='margin-top: 20px; font-size: 16px;'>
        <strong>Scorecards are based on 2022 ACS Census data.</strong> Quartiles are displayed to show discrepancies in outcomes for people with disabilities across states. 
        <strong>Q1</strong> represents the bottom 25%, <strong>Q2</strong> is 25-50%, <strong>Q3</strong> is 50-75%, and <strong>Q4</strong> is the top 25%.
      </p>")
    )
  ),

...
vars_dict <-  read_csv(here("dictionaries", "dict_vars.csv")) # TODO: Change fun_pull_mongo_data() so it can pull vars_dict from db
```
...
### Demographics
tables <- c("S1810")
national_demographic <- fun_pull_mongo_data(tables, "state")
rm(tables)

### Community Living
tables <- c("S2601A", "S2602", "S1810")
national_living <- fun_pull_mongo_data(tables, "state")
rm(tables)

### Community Participation
tables <- c("B18135", "S1811", "S1810")
national_participation <- fun_pull_mongo_data(tables, "state")
rm(tables)

### Work/Economic
tables <- c("B18135", "B18140", "C18120", "C18121", "C18130", "S1811", "B25091", "B25070")
national_economic <- fun_pull_mongo_data(tables, "state")
rm(tables)
```
...
# State Lookup
mongo_conn_input <- fun_mongo_connect(collection_name = "acs_place_S1810",

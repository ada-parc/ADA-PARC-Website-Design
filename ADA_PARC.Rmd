...
output$national_map_summary <- renderUI({
  ...
  HTML(
    paste0(
      ...
      " Detailed information is available to the right in the interactive map (top) and table (bottom).<br><br>Source: 2016-2020 American Community Survey five-year estimates")
  )

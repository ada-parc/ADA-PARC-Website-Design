...
- data/all_2020N_2019C.rda
- data/ADA-Website_tables.Rda
...
# load(here::here("data", "all_2020N_2019C.rda"))
# load(here::here("data", "ADA-Website_data.Rda"))
load(here::here("data", "ADA-Website_tables.Rda"))
load(here::here("data", "ADA-Website_tracts.Rda"))
read.csv(here::here("data", "dict_vars.csv"))

dict_location_crosswalk <- dict_location_crosswalk %>%
  mutate(city = str_remove(metro_state, ", [A-Z]{2}$"),
...
output$city_summary <- renderUI({
  ...
  city_summary_text <- paste0(
    ...
    city_place() %>% 
      ...
      pull(NAME), "</h4>",
    "Based on ACS 2020 5-Year Estimates, <b>", city_place() %>% 

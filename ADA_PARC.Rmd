...
ui <- fluidPage(
  ...
  tags$head(
    tags$style(HTML("
      ...
      .main-content {
        flex-grow: 1; /* Makes sure the content fills up the space */
  ...
  fluidRow(
    column(3, class = "sidebar",
           div(
             h4("How to Navigate this Website"),
             p("Use the National Data tab to examine the status of people with disabilities at the national and state level."),
             p("Use the City Data tab to investigate people with disabilities statistics at the municipal level."),
             p("Use the Scorecard tabs to view our state by state report cards for each category."),
             p("Use the About tab to learn more about the ADA-PARC project."),
             p("Use the Settings tab to set color palettes for the visualizations in this dashboard."),
             h5("Questions?"),
             tags$a(href="mailto:joyhammel@uic.edu", "Contact Joy Hammel (email)"),
             p("Director of Graduate Studies UIC College of Applied Health Sciences")
           )
    ),
    column(9, class = "container",
           div(class = "main-content",
               ...
               div(class = "grant-info",
                   "ADA-PARC is funded by the National Institute on Disability, Independent Living, and Rehabilitation Research (NIDILRR) under grant numbers 90DP0026 and 90DPAD0001.",
                   tags$br(),
                   "NIDILRR is a center within the Administration for Community Living (ACL) at the Department of Health and Human Services (HHS). The content of this website does not necessarily reflect the policy of NIDILRR, ACL, or HHS and should not be regarded as endorsed by the Federal Government."
               )
           ),
           div(class = "footer",

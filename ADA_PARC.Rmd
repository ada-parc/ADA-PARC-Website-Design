...
server <- function(input, output) {
  output$markdown_image <- renderUI({
    HTML(markdown::markdownToHTML(text = "![Status for Disabled Image](www/Status_for_Disabled_image.png){style='width:80%;'}"))
  })
}

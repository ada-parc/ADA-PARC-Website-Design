...
# Show modal during function call
observeEvent(input$states_download_button, {
  
  # Open popup to inform user
  showModal(modalDialog("Requesting state ACS data from API...",
                        footer = NULL))
  
  # Close popup when rows present
  if (nrow( acs_state_raw() > 0)) {
    removeModal()
  }

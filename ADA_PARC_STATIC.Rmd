...
# OLDER VERSION OF 2022 ADA-PARC, DO NOT CHANGE, HERE FOR BACKUP
...
city_summary_items <- city_place() %>%
  mutate(
    "Living In Poverty" = create_number_percent_string(pwd_below_poverty, pwd_below_poverty_pct),
    "Car Commute" = create_number_percent_string(pwd_car_commute, pwd_car_commute_pct),
      ...
      column(
        ...
        div(class = "sidebar",
            ...
            p(style = "font-size: 85%;",  
              "Scorecard dashboards are based on data from 2022 Census Data via the ACS. For more information on their development and interpretation, see the ‘Scorecards - Report’ tab, for a downloadable report which explains the purpose of a scorecard approach and examples of how to understand them."),
